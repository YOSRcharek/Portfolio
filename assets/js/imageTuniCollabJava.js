...
// Images TuniCollab
const myImagesTuniCollabJava = [];
for (let i = 1; i <= 11; i++) {
  myImagesTuniCollabJava.push(`./assets/images/tuniCollabJava${i}.png`);
}
initCarousel("carouselModalTuniCollabJava", "TuniCollabJava-carousel", myImagesTuniCollabJava);
